...
```{r average-weight-time-facet_sex_rows, purl=FALSE}
...
```{r average-weight-time-facet_sex_columns, purl=FALSE}
...
```{r number_species_year_with_right_labels, purl=FALSE}
ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex, group = sex)) +
    geom_line() +
    facet_wrap(~ species_id) +
...
```{r number_species_year_with_right_labels_xfont_size, purl=FALSE}
ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex, group = sex)) +
    geom_line() +
    facet_wrap(~ species_id) +
    labs(title = 'Observed species in time',
...
```{r number_species_year_with_theme, purl=FALSE}
ggplot(data = yearly_sex_counts, aes(x = year, y = n, color = sex, group = sex)) +
    geom_line() +
    facet_wrap(~ species_id) +
    labs(title = 'Observed species in time',
...
```{r number_species_year_with_right_labels_xfont_orientation, purl=FALSE}
